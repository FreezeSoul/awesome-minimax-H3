...
| `fl2v DMD 8-step` · experimental | 8 | Full | ![bf16][badge-bf16] | 2.12 GB | [![][gh-drbaph]](https://huggingface.co/drbaph/MiniMax-H3-Turbo-Lora-ComfyUI/resolve/main/experimental/minimax_h3_dmd_8step_turbo.safetensors) |
| `fl2v DMD 8-step · pruned` · experimental | 8 | Pruned | ![bf16][badge-bf16] | 2.13 GB | [![][gh-drbaph]](https://huggingface.co/drbaph/MiniMax-H3-Turbo-Lora-ComfyUI/resolve/main/experimental/minimax_h3_dmd_fl2va_8step_turbo_pruned.safetensors) |
| `ref2v DMD 8-step · pruned` · experimental | 8 | Pruned | ![bf16][badge-bf16] | 2.13 GB | [![][gh-drbaph]](https://huggingface.co/drbaph/MiniMax-H3-Turbo-Lora-ComfyUI/resolve/main/experimental/minimax_h3_dmd_ref2va_8step_turbo_pruned.safetensors) |
...
*drbaph's `experimental/` folder adds DMD 8-step turbo LoRAs — a full-layout FL2VA file plus pruned FL2VA / Ref2VA variants (2.12–2.13 GB); not yet documented in the repo README.*
...
| [INT8 R2V (javano2609.2.1)](https://huggingface.co/javawock7618/comfy-MiniMax-H3-workflows/resolve/main/MiniMax_int8_R2V-javano2609.2.1.json) | javawock7618 | Ref2VA | INT8 low-VRAM reference-to-video workflow — Reference LoRA, ControlNet Union V2V, Extend, and Latent Upscaler. Current version (older 2608.x/2609.1.x files removed from the repo). |
